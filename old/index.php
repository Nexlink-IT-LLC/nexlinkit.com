...
<head>
    ...
    <title>Professional IT services</title>
    ...
    <style>
        ...
        body {
            ...
            background: url('assets/northlights.jpg') center center / cover no-repeat fixed;
            position: relative;
        }
        body::before {
            content: "";
    ...
    <script>
        const translations = {
            en: {
                ...
                heroDesc: 'Get expert help with Linux, servers, hosting, Nextcloud and much more, for affordable prices.',
                cta: 'Request Support',
                widgets: [
            ...
            no: {
                reviews: 'Anmeldelser',
                contact: 'Kontakt',
                heroTitle: 'Profesjonelle IT-tjenester',
                heroDesc: 'Få experthjelp med Linux, servere, hosting, Nextcloud og mye mer for rimelige priser.',
                cta: 'Be om støtte',
                widgets: [
                    ...
                    ['Basert i Norge', 'Basert i Akershus, og hjelper kunder over hele Europa, USA og mer.']
                ],
